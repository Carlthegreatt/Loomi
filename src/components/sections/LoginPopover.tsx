          ...
          <div className="relative bg-[#171717] z-10 w-80 rounded-xl p-6 backdrop-blur-sm border-spacing-0">
            ...
            <form className="space-y-3">
              ...
              <input
                ...
                className="w-full bg-[#212121] px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <h1 className="text-white text-sm">Password</h1>
              <input
                type="password"
                className="w-full bg-[#212121] px-3 py-2 border rounded-md focus:outline-none focus:ring-2"
              />
              <button
                type="submit"

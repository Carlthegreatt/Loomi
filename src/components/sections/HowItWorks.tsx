...
export default function HowItWorks() {
  return (
    <div className="container flex-wrap:wrap mx-auto px-4 sm:px-6 lg:px-8 bg-[#0a0a0a]">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 flex mb-12 max-w-5xl mx-auto">
